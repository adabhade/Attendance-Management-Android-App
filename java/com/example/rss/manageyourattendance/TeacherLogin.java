...
public class TeacherLogin extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etUsername = (EditText) findViewById(R.id.editTextTUsername);
        etPassword = (EditText) findViewById(R.id.editTextTPassword);
        btn = (Button) findViewById(R.id.button);
        intent = new Intent(getBaseContext(),TeacherOperations.class);
    }
    ...
    public class LoginClass extends AsyncTask<String,Void,String> {
        ...
        protected String doInBackground(String... params) {
            String teacherLoginURL = "http://attendance-systemapp.000webhostapp.com/Login_Teacher.php";
